...
parser.add_argument('--mmdb', type=str, help="Filename of Maxmind mmdb file for prefixes lookup and return description/ASN", nargs='?', default='GeoLite2-ASN.mmdb')
parser.add_argument('--ipaddress', type=str, help="IP address lookup", nargs='?', default = '')
parser.add_argument('--asn', type=str, help="ASN lookup", nargs='?', default = '')
parser.add_argument('--mrt', type=str, help="Lookup using MRT file instead of mmdb", nargs='?', default = '')
